        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
                    <!--================================= LOGO================================= -->
                    <div class="logo"> <a href="#"> <img src="{{ asset('images/logo.png') }}" alt="logo">
                        </a> </div>
                    <!-- /.logo -->
                    <!--================================= LOGO : END================================= -->
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-4">
                                            <div class="image"> <a href="detail.html"><img
                                                        src="{{ asset('images/products/p4.jpg') }}" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="col-xs-7">
                                            ...
                                            <div class="yamm-content ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-4 col-menu banner-image">
                                                        <img class="img-responsive mw-100"
                                            ...
                                            <div class="yamm-content">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-4 col-menu custom-banner">
                                                        <a href="#"><img alt=""
                                                                style=" max-width: 100%; "
                                                                src="{{ asset('/images/banners/top-menu-banner1.jpg') }}"></a>
                                                    </div>
                                                </div>
                                                <!-- /.row -->
                                            </div>
                                ...
                                <li class="dropdown"> <a href="#" class="dropdown-toggle"
                                    ...
                                    <ul class="dropdown-menu pages">
                                        <li>
                                            <div class="yamm-content">
                                                <div class="row">
                                                    <div class="col-xs-12 col-menu d-flex">
                                                        <ul class="links">
