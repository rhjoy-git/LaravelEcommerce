                                    ...
                                    <div class="product-image">
                                        <div class="image">
                                            ...
                                            <a href=" {{ route('detail') }} ">
                                                ...
                                                <img src=" {{ asset('images/products/p6_hover.jpg') }}"
                                    ...
                                    <div class="product-image">
                                        <div class="image">
                                            ...
                                            <a href=" {{ route('detail') }} ">
                                                ...
                                                <img src=" {{ asset('images/products/p7_hover.jpg') }}"
                                                    alt="" class="hover-image">
                                            </a>
                                        </div>
                                        <!-- /.image -->
                                    ...
                                    <div class="product-image">
                                        <div class="image">
                                            ...
                                            <a href=" {{ route('detail') }} ">
                                                ...
                                                <img src=" {{ asset('images/products/p8_hover.jpg') }}"
                                                    alt="" class="hover-image">
                                            </a>
                                        </div>
                                        <!-- /.image -->
                                    ...
                                    <div class="product-image">
                                        <div class="image">
                                            <a href=" {{ route('detail') }} ">
                                                ...
                                                <img src=" {{ asset('images/products/p9_hover.jpg') }}"
                                                    alt="" class="hover-image">
                                            </a>
                                        </div>
                                        <!-- /.image -->
                                    ...
                                    <div class="product-image">
                                        <div class="image">
                                            ...
                                            <a href=" {{ route('detail') }} ">
                                                ...
                                                <img src=" {{ asset('images/products/p10_hover.jpg') }}"
                                                    alt="" class="hover-image">
                                            </a>
                                        </div>
                                        <!-- /.image -->
                                    ...
                                    <div class="product-image">
                                        <div class="image">
                                            <a href=" {{ route('detail') }} ">
                                                ...
                                                <img src=" {{ asset('images/products/p11_hover.jpg') }}"
                                                    alt="" class="hover-image">
                                            </a>
                                        </div>
                                        <!-- /.image -->
                                    ...
                                    <div class="product-image">
                                        <div class="image">
                                            <a href=" {{ route('detail') }} ">
                                                ...
                                                <img src=" {{ asset('images/products/p15_hover.jpg') }}"
                                                    alt="" class="hover-image">
                                            </a>
                                        </div>
                                        <!-- /.image -->
                                    ...
                                    <div class="product-image">
                                        <div class="image">
                                            <a href=" {{ route('detail') }} ">
                                                ...
                                                <img src=" {{ asset('images/products/p14_hover.jpg') }}"
                                                    alt="" class="hover-image">
                                            </a>
                                        </div>
                                        <!-- /.image -->
                                    ...
                                    <div class="product-image">
                                        <div class="image">
                                            <a href=" {{ route('detail') }} ">
                                                ...
                                                <img src=" {{ asset('images/products/p13_hover.jpg') }}"
                                                    alt="" class="hover-image">
                                            </a>
                                        </div>
                                        <!-- /.image -->
                                ...
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image">
                                            <a href=" {{ route('detail') }} ">
                                                <img src=" {{ asset('images/products/p5.jpg') }}" alt="">
                                                <img src=" {{ asset('images/products/p5_hover.jpg') }}"
                                                    alt="" class="hover-image">
                                            </a>
                                        </div>
                                        <!-- /.image -->
                                    ...
                                    <div class="product-image">
                                        <div class="image">
                                            <a href=" {{ route('detail') }} ">
                                                ...
                                                <img src=" {{ asset('images/products/p12_hover.jpg') }}"
                                                    alt="" class="hover-image">
                                            </a>
                                        </div>
                                        <!-- /.image -->
                        ...
                        <div class="product-list product">
                            <div class="row product-list-row">
                                <div class="col col-sm-3 col-lg-3">
                                    <div class="product-image">
                                        <div class="image"> <img src=" {{ asset('images/products/p3.jpg') }}"
                                                alt=""> </div>
                                    </div>
                                    <!-- /.product-image -->
                                </div>
                                ...
                                <div class="col col-sm-9 col-lg-9">
                                    <div class="product-info">
                                        ...
                                        <div class="product-price"> <span class="price"> $450.99 </span> <span
                                                class="price-before-discount">$ 800</span> </div>
                                        <!-- /.product-price -->
                                        <div class="description m-t-10">Suspendisse posuere arcu diam, id accumsan
                                            eros pharetra ac. Nulla enim risus, facilisis bibendum gravida eget, lacinia
                                            id purus. Suspendisse posuere arcu diam, id accumsan eros pharetra ac. Nulla
                                            enim risus, facilisis bibendum gravida eget. Suspendisse posuere arcu diam,
                                            id accumsan eros pharetra ac. Nulla enim risus, facilisis bibendum gravida
                                            eget, lacinia id purus. Suspendisse posuere arcu diam, id accumsan eros
                                            pharetra.</div>
                                        <div class="cart clearfix animate-effect">
                                            <div class="action">
                                                <ul class="list-unstyled">
                    ...
                    <div class="products">
                        <div class="product-list product">
                            <div class="row product-list-row">
                                <div class="col col-sm-3 col-lg-3">
                                    <div class="product-image">
                                        <div class="image"> <img src=" {{ asset('images/products/p4.jpg') }}"
                                                alt=""> </div>
                                    </div>
                                    <!-- /.product-image -->
                                </div>
                    ...
                    <div class="products">
                        <div class="product-list product">
                            <div class="row product-list-row">
                                <div class="col col-sm-3 col-lg-3">
                                    <div class="product-image">
                                        <div class="image"> <img src=" {{ asset('images/products/p5.jpg') }}"
                                                alt=""> </div>
                                    </div>
                                    <!-- /.product-image -->
                                </div>
                    ...
                    <div class="products">
                        <div class="product-list product">
                            <div class="row product-list-row">
                                <div class="col col-sm-3 col-lg-3">
                                    <div class="product-image">
                                        <div class="image"> <img src=" {{ asset('images/products/p6.jpg') }}"
                                                alt=""> </div>
                                    </div>
                                    <!-- /.product-image -->
                                </div>
                    ...
                    <div class="products">
                        <div class="product-list product">
                            <div class="row product-list-row">
                                <div class="col col-sm-3 col-lg-3">
                                    <div class="product-image">
                                        <div class="image"> <img src=" {{ asset('images/products/p7.jpg') }}"
                                                alt=""> </div>
                                    </div>
                                    <!-- /.product-image -->
                                </div>
                    ...
                    <div class="products">
                        <div class="product-list product">
                            <div class="row product-list-row">
                                <div class="col col-sm-3 col-lg-3">
                                    <div class="product-image">
                                        <div class="image"> <img src=" {{ asset('images/products/p8.jpg') }}"
                                                alt=""> </div>
                                    </div>
                                    <!-- /.product-image -->
                                </div>
                    ...
                    <div class="products">
                        <div class="product-list product">
                            <div class="row product-list-row">
                                <div class="col col-sm-3 col-lg-3">
                                    <div class="product-image">
                                        <div class="image"> <img src=" {{ asset('images/products/p9.jpg') }}"
                                                alt=""> </div>
                                    </div>
                                    <!-- /.product-image -->
                                </div>
                    ...
                    <div class="products">
                        <div class="product-list product">
                            <div class="row product-list-row">
                                <div class="col col-sm-3 col-lg-3">
                                    <div class="product-image">
                                        <div class="image"> <img src=" {{ asset('images/products/p10.jpg') }}"
                                                alt=""> </div>
                                    </div>
                                    <!-- /.product-image -->
                                </div>
                    ...
                    <div class="products">
                        <div class="product-list product">
                            <div class="row product-list-row">
                                <div class="col col-sm-3 col-lg-3">
                                    <div class="product-image">
                                        <div class="image"> <img src=" {{ asset('images/products/p11.jpg') }}"
                                                alt=""> </div>
                                    </div>
                                    <!-- /.product-image -->
                                </div>
                    ...
                    <div class="products">
                        <div class="product-list product">
                            <div class="row product-list-row">
                                <div class="col col-sm-3 col-lg-3">
                                    <div class="product-image">
                                        <div class="image"> <img src=" {{ asset('images/products/p12.jpg') }}"
                                                alt=""> </div>
                                    </div>
                                    <!-- /.product-image -->
                                </div>
                    ...
                    <div class="products">
                        <div class="product-list product">
                            <div class="row product-list-row">
                                <div class="col col-sm-3 col-lg-3">
                                    <div class="product-image">
                                        <div class="image"> <img src=" {{ asset('images/products/p13.jpg') }}"
                                                alt=""> </div>
                                    </div>
                                    <!-- /.product-image -->
                                </div>
                    ...
                    <div class="products">
                        <div class="product-list product">
                            <div class="row product-list-row">
                                <div class="col col-sm-3 col-lg-3">
                                    <div class="product-image">
                                        <div class="image"> <img src=" {{ asset('images/products/p14.jpg') }}"
                                                alt=""> </div>
                                    </div>
                                    <!-- /.product-image -->
                                </div>
